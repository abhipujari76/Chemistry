...
const Animation = () => {
    ...
    const videoIds = ['V5ep0-ojPGw', 'xRGR5ZvO3AU', 'J1FjIRWVwTM', '7N2Dn7OgjWI', 'eQlnHr9g6Io', 'cw-Wc_KjHgc'];
    ...
    return (
      ...
      <div className="video-overlay">
            ...
            <Link to="/Procedure3"><button className="back-button2">Back to Procedure</button></Link>
